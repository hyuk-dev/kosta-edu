...
interface InterfaceExam00{ // 생성 x 상속 x
...
abstract class SubClassExam03 
			implements InterfaceExam01, InterfaceExam02{} // 인터페이스만 implements 뒤에 올 수 있음
...
class SubClassExam04 extends SubClassExam02{
	...
	void printSuperString(){
		InterfaceExam01 ie01 /*= new InterfaceExam01()*/; //  인터페이스는 생성 및 상속 불가
